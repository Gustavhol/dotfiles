...
(defface neuron-stub-face
  ...
  "Face for stub links."
  :group 'neuron-faces)
(customize-set-variable 'neuron-default-zettelkasten-directory (expand-file-name "~/Documents/zettelkasten"))
...
(use-package! neuron-mode
  ...
  (map! :leader
        (:prefix ("z" . "zettel")
          ...
          "n" #'neuron-insert-new-zettel
          "i" #'neuron-insert-zettel-link
          "c" #'neuron-create-zettel-from-selected-title
